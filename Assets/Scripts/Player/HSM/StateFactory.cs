...
public class PlayerStateFactory
{
    ...
    public PlayerStateFactory(Player currentContext, PlayerData playerData)
    {
        ...
        PrimaryAttackState = new PlayerAttackState(context, this, playerData, "Attack", CombatInputs.Primary);
        SecondaryAttackState = new PlayerAttackState(context, this, playerData, "Attack", CombatInputs.Secondary);
    }
}
